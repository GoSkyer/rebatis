...
//
//  public TableModel(ProcessingEnvironment env, TypeMirrorFactory typeFactory, TypeElement modelElt) {
...
//    Table ann = modelElt.getAnnotation(Table.class);
//    this.generateConverter = false;
//    this.publicConverter = false;
//    this.inheritConverter = false;
...
//      .filter(superTM -> superTM instanceof DeclaredType && ((DeclaredType) superTM).asElement().getAnnotation(Table.class) != null)
...
//    if (superClass instanceof DeclaredType && ((DeclaredType) superClass).asElement().getAnnotation(Table.class) != null) {
...
//            filter(elt -> !annotated || elt.getAnnotation(Table.class) != null).
...
//          } else {
//            declared = ownerElt.getAnnotation(Table.class) == null;
//          }
//        }
//      }
//    }
